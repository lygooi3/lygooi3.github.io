...
function drawGauge() {
    ...
    setInterval(function() {
      ...
      var GaugeOptions = { height: 295, min: 0, max: 3, majorTicks: ['0','1','2'], minorTicks: 5};
    ...
    setInterval(function() {
      ...
      var GaugeOptions2 = { height: 295, min: 0, max: 10, majorTicks: ['0','2','4','6','8','10'], minorTicks: 2};
      gauge4.draw(data4, GaugeOptions2);
    }, 1000);  
  } 
